...
BUILTIN_ROUTING_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "cer_weighted": {
        ...
        "label": "CER / peso directo",
        "description": "Politica directa: minimiza tiempo + seguridad + penalizacion por baja CER estructural.",
        "routing": {
            "algorithm": "dijkstra",
            "costPolicy": "minimum_travel_time",
            "useHazardRisk": True,
    ...
    "cer_agility_yen": {
        ...
        "label": "CER / k-rutas",
        "description": "Genera candidatas con Yen y selecciona la ruta que atraviesa nodos con mayor CER.",
        "routing": {
            "algorithm": "yen_ksp",
            "costPolicy": "minimum_travel_time",
            "useHazardRisk": True,
